    ...
    <div class="content">
      <div class="container">
        <div class="col col-md-6 offset-md-3 align-self-center">
          <h1 class="font-weight-bold border border-dark rounded-pill align-middle text-advert">Створення оголошення</h1>
        </div>
        ...
        <div class="row">
          ...
          <div class="col col-6">
            <select @click="ResetAdvAddinsh()" v-model="advert.category" class="form-control">
              <option>Одяг</option>
          ...
          <div class="col col-6">
            <select v-model="advert.filter" class="form-control">
          ...
          <div class="col col-6">
            <h2>Срок: <p class="text-danger reded">*</p> </h2>
          </div>
          <div class="col col-6">
            <select v-model="advert.term" class="form-control">
          ...
          <div class="col col-6">
            <input class="col col-12" type="text" placeholder="Введіть заголовок оголошення" value="" v-model="advert.subject">
          </div>
          ...
          <div class="col col-6">
            <textarea v-model="advert.description" placeholder="Введіть опис оголошення" rows="5" cols="80" class="col col-12 description form-control"></textarea>
            <!-- <input class="col col-12 description" type="text"  value="" v-model="advert.description"> -->
          </div>
          ...
          <div class="col col-6">
            <div class="input-group mb-3">
              ...
              <input type="text" class="form-control"  v-model="advert.price" aria-label="Amount (to the nearest dollar)">
        ...
        <div class="row ">
          ...
          <div class="col col-6">
            <button class="btn btn-lg btn-primary" @click="CreateAdv()" type="submit"><h5>Відправити на модерацію</h5></button>
          </div>
          <div class="col col-3"></div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      CreateAdv(){
        ...
        if (this.advert.term === '1 день') {
          this.advert.termid = 1;
        } else if (this.advert.term === '3 дні') {
          this.advert.termid = 2;
        } else if (this.advert.term === '1 тиждень') {
          this.advert.termid = 3;
        } else if (this.advert.term === '1 місяць') {
          this.advert.termid = 4;
        } else if (this.advert.term === '6 місяців') {
          this.advert.termid = 5;
        } else if (this.advert.term === '1 рік') {
          this.advert.termid = 6;
        }
        ...
        if(this.advert.category === '' || this.advert.filter === '' || this.advert.subject === '' || this.advert.description === '' || this.advert.term === '' || this.advert.price === ''){
          this.mess = "Ви не заповнили обов'язкові поля. Будь-ласка, заповніть їх та спробуйте знову.";
          return;
        }

        $.ajax({
          url: this.$store.getters.get_url_server + "create/",
          type: "POST",

          data: {
              // 'user': this.$store.getters.get_user_info.pk,
